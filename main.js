...
addBtn.onclick = ()=>{
    ...
    let getLocalStorageData = localStorage.getItem("Thêm công việc");
    ...
    localStorage.setItem("Thêm công việc", JSON.stringify(listArray)); // Chuyển JSON từ dạng Object sang String
    showTasks();
    addBtn.classList.remove("active");
}
function showTasks(){
...
function deleteTask(index){
  ...
  localStorage.setItem("Thêm công việc", JSON.stringify(listArray));
  showTasks();
}
